...
choix(position1,position2,position3,&NbFus1,&NbFus2,&NbFus3);
...
void choix(char position[15][15],char position2[15][15],char position3[15][15],int* NbFus1, int* NbFus2, int* NbFus3)
{
int choix,verif;
...
if (choix==1)
{
    tirerjvj(position2,position3,&NbFus1,&NbFus2,&NbFus3);
    verif=0;
}
if (choix==2)
{
